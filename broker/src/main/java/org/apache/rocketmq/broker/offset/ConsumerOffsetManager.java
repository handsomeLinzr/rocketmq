...
public class ConsumerOffsetManager extends ConfigManager {
    ...
    private ConcurrentMap<String/* topic@group */, ConcurrentMap<Integer, Long>> offsetTable =   // offset消费进度
    ...
    private final ConcurrentMap<String/* topic@group */, ConcurrentMap<Integer, Long>> pullOffsetTable =
        new ConcurrentHashMap<>(512);   // 记录拉取的offset消费
    ...
    public long queryOffset(final String group, final String topic, final int queueId) {
        ...
        ConcurrentMap<Integer, Long> map = this.offsetTable.get(key);  // 从offsetTable中获取偏移
        if (null != map) {
