...
public abstract class AbstractTransactionalMessageCheckListener {
    ...
    private static volatile ExecutorService executorService;  // 已经初始化
    ...
    public void sendCheckMessage(MessageExt msgExt) throws Exception {
        ...
        Channel channel = brokerController.getProducerManager().getAvailableChannel(groupId);  // 从生产组中获取一个channel进行发送
        if (channel != null) {
