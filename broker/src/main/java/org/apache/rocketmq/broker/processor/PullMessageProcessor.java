...
public class PullMessageProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request, boolean brokerAllowSuspend)
        ...
        MessageFilter messageFilter;  // 过滤器
    ...
    protected void tryCommitOffset(boolean brokerAllowSuspend, PullMessageRequestHeader requestHeader,
        ...
        boolean storeOffsetEnable = brokerAllowSuspend;  // true
        final boolean hasCommitOffsetFlag = PullSysFlag.hasCommitOffsetFlag(requestHeader.getSysFlag());  // 是否允许自动提交
    ...
    protected void updateBroadcastPulledOffset(String topic, String group, int queueId,
        ...
        if (isBroadcast(proxyPullBroadcast, consumerGroupInfo)) {
            ...
            this.brokerController.getBroadcastOffsetManager()   // 更新广播的offset
