...
public class RemotingCodeDistributionHandler extends ChannelDuplexHandler {
    ...
    private final ConcurrentMap<Integer, LongAdder> inboundDistribution;  // 存放请求进来的requestCode
    private final ConcurrentMap<Integer, LongAdder> outboundDistribution;  // 存放返回出去的responseCode
