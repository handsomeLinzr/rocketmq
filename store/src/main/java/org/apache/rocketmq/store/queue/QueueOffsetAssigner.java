...
public class QueueOffsetAssigner {
    ...
    private ConcurrentMap<String, Long> topicQueueTable = new ConcurrentHashMap<>(1024); // 记录topic-queue->num
    ...
    public long assignQueueOffset(String topicQueueKey, short messageNum) {
        Long queueOffset = ConcurrentHashMapUtils.computeIfAbsent(this.topicQueueTable, topicQueueKey, k -> 0L);  // queue偏移
